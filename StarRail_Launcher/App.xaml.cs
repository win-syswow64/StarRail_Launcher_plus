...
namespace StarRail_Launcher
{
    public partial class App : Application
    {
        private readonly SingleInstanceChecker singleInstanceChecker = new("StarRailLauncher");
        public App()
        {
            LoadProgramCore = new();
            DataModel = new();
        ...
        {
            if (File.Exists(@"StarRail.exe") &&
                Directory.Exists(@"StarRail_Data"))
            {
